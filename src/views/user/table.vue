<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="username" min-width="110px">
        <template slot-scope="{row}">
          <span class="link-type" @click="handleUpdate(row)">{{ row.username }}</span>
        </template>
      </el-table-column>
      <el-table-column label="loginName" width="110px" align="center">
        <template slot-scope="{row}">
      ...
      <el-table-column label="updateTime" width="150px" align="center">
        <template slot-scope="{row}">
          <span>{{ row.updateTime | parseTime('{y}-{m}-{d} {h}:{i}') }}</span>
        </template>
      </el-table-column>
      <el-table-column label="updater" width="110px" align="center">
        <template slot-scope="{row}">
      ...
      <el-table-column label="Actions" align="left" width="215" class-name="small-padding fixed-width">
